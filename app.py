...
import pandas as pd
import matplotlib.pyplot as plt  # if you used earlier
import streamlit as st
import plotly.express as px  # <- add this at top with other imports

# Step 1: Load data
dau = pd.read_csv("app_usage.csv")

# Step 2: (Optional) Existing matplotlib plot
# plt.plot(dau["date"], dau["Daily Active Users"])
# plt.show()

# Step 3: Plotly chart - last la paste pannalam
fig = px.line(
    dau,
    x="date",
    y="Daily Active Users",
...
st.title("App Usage Analytics Dashboard")
st.plotly_chart(fig)  # <- Streamlit-la chart display pannum
